...
interface AppWireServiceInterface extends JsonSerializable, WireServiceInterface
{
    ...
    public function getService(string $id, int $invalidBehavior = ContainerInterface::NULL_ON_INVALID_REFERENCE): ?object;
    public function getClassService(string|object $objectOrClass): ?object;
    // Initialized
    public function initialize(): bool;
    public function isInitialized(): bool;
    public function retrieveAppWire(?string $firewall = null): ?array;
    ...
    public function getDatetime(string|DateTimeImmutable $date = 'now'): DateTimeImmutable;
    // Locale / Languages
